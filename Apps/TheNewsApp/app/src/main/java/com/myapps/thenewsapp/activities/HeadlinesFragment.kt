...
import com.myapps.thenewsapp.databinding.FragmentHeadlinesBinding
import com.myapps.thenewsapp.util.Constants
...
class HeadlinesFragment : Fragment(R.layout.fragment_headlines ) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            if (it.url != null && it.title != null) {
                ...
                Toast.makeText(context, "Invalid article", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    val scrollListener = object : RecyclerView.OnScrollListener(){
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isTotalMoreThanVisible = totalItemCount >= 0
